    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(awsClient2.AWSECommerceService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = awsClient2.AWSECommerceService.class.getResource(".");
