...
public class TimeServerImplService extends Service {
	...
	private final static Logger logger = Logger
			.getLogger(ch01.ts.client.TimeServerImplService.class.getName());

	static {
		URL url = null;
		try {
			URL baseUrl;
			baseUrl = ch01.ts.client.TimeServerImplService.class
					.getResource(".");
	...
	public TimeServerImplService() {
		super(TIMESERVERIMPLSERVICE_WSDL_LOCATION, new QName("http://ts.ch01/",
				"TimeServerImplService"));
	}

	/**
	 * 
	 * @return returns TimeServer
	 */
